...
/********************************************************************************/
using Communication.Models.NFeModel.Info.Cana;
using Communication.Models.NFeModel.Info.Cobranca;
using Communication.Models.NFeModel.Info.Destinatario;
using Communication.Models.NFeModel.Info.Detalhe;
using Communication.Models.NFeModel.Info.Emitente;
using Communication.Models.NFeModel.Info.Identificacao;
using Communication.Models.NFeModel.Info.InfRespTec;
using Communication.Models.NFeModel.Info.Intermediador;
using Communication.Models.NFeModel.Info.Observacoes;
using Communication.Models.NFeModel.Info.Pagamento;
using Communication.Models.NFeModel.Info.Total;
using Communication.Models.NFeModel.Info.Transporte;
using System.Collections.Generic;
using System.Xml.Serialization;


namespace Communication.Models.NFeModel.Info
{
    public class infNFe
    {
        public infNFe()
