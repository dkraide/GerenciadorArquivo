...
using Communication.Models.NFeModel.Info.Detalhe.DeclaracaoImportacao;
using Communication.Models.NFeModel.Info.Detalhe.Exportacao;
using Communication.Models.NFeModel.Info.Detalhe.ProdEspecifico;
using Communication.Models.NFeModel.Utils;

namespace Communication.Models.NFeModel.Info.Detalhe
{
    public class prod
    {
        public prod()
