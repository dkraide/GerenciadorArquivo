...
using Communication.Models.NFeModel.Flags;
using Communication.Models.NFeModel.Info.Identificacao.Tipos;
using Communication.Models.NFeModel.Utils;

namespace Communication.Models.NFeModel.Info.Identificacao
{
    public class ide
    {
        /// <summary>
